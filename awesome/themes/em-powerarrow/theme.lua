...
local theme                                     = {}
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/em-powerarrow"
...
local binclock = wibox.widget.textclock(markup("#7788af", "%A %d %B ") .. markup("#ab7367", ">") .. markup('#de5e1e', " %H:%M "))
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            arrow("#4B696D", "#CB755B"),
            wibox.container.background(wibox.container.margin(wibox.widget { tempicon, temp.widget, layout = wibox.layout.align.horizontal }, dpi(4), dpi(4)), "#CB755B"),
            --arrow("#4B3B51", "#CB755B"),
            ...
            arrow("#C0C0A2", "#000"),
            wibox.container.background(wibox.container.margin(binclock, dpi(4), dpi(8)), "#000"),
            arrow("#000", "alpha"),
            --]]
            s.mylayoutbox,
        },
